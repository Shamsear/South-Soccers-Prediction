 ...
 * 
 * Public page showing leaderboard - same UI as authenticated leaderboard page
 */
  ...
  return (
    <div className="relative min-h-screen bg-[#030306] overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl relative z-10">
        ...
        {/* Leaderboard Table */}
        <LeaderboardTable leaderboard={typedLeaderboard} currentUserId={null} />
        ...
        <div className="mt-16 text-center bg-[#0E0E13] border-2 border-white/5 max-w-2xl mx-auto p-8 rounded-xl shadow-2xl">
          ...
          <p className="text-[#C1C5D0] mb-8 text-sm max-w-md mx-auto">
            Sign up now, submit predictions for matches, and make your way to the top of the leaderboard.
          </p>
